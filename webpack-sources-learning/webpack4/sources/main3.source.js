(function (modules) {
  ...
  /************************************************************************/
  {
    "./src/async.js": function (module, exports, __webpack_require__) {
      Promise.resolve(/*! import() */)
        .then(__webpack_require__.bind(null, /*! ./sync */ "./src/sync.js"))
        .then((data) => {
          console.log(data);
        });
      console.log("async");
    ...
    "./src/index.js": function (
      ...
      __webpack_require__
        .e(/*! import() */ 0)
        .then(__webpack_require__.bind(null, "./src/sync2.js"))
        .then((_) => {
          console.log("异步获取2：", _);
        });
