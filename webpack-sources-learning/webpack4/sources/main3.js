...
eval("Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./sync */ \"./src/sync.js\")).then((data) => {\n  console.log(data);\n});\nconsole.log(\"async\");\n\n\n//# sourceURL=webpack:///./src/async.js?");
