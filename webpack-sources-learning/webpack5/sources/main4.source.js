(() => {
  var __webpack_modules__ = {
    ...
    "./src/index.js": (
      ...
      var _async__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(
      ...
      __webpack_require__
        .e("src_sync2_js")
        .then(__webpack_require__.bind(__webpack_require__, "./src/sync2.js"))
        .then((_) => {
          console.log("异步获取2：", _);
        });
  ...
  (() => {
    var inProgress = {};
    var dataWebpackPrefix = "webpack5:"; // loadScript function to load a script via script tag
  ...
  (() => {
    ...
    var chunkLoadingGlobal = (self["webpackChunkwebpack5"] =
      self["webpackChunkwebpack5"] || []);
